...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='LUX'' package/default-settings/files/zzz-default-settings
...
sed -i 's/"Turbo ACC 网络加速"/"Turbo ACC"/g' package/lean/luci-app-flowoffload/po/zh-cn/flowoffload.po
sed -i 's/"Turbo ACC 网络加速"/"Turbo ACC"/g' package/lean/luci-app-sfe/po/zh-cn/sfe.po
